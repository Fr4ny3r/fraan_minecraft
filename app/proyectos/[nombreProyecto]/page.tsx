...
export default async function ProjectPage({ params }: { params: { nombreProyecto: string } }) {
  ...
  return (
    <section className="contenedor-scroll-personalizado xl:overflow-x-hidden xl:overflow-smooth xl:overflow-y-auto w-full w-full xl:max-w-128 xl:max-h-145 z-1000 relative bg-[var(--accent)]/12 dark:bg-background/80 backdrop-blur-[var(--blur)] rounded-lg p-8 py-12">
